...
describe('Test Content Load', () => {
	it('Loads Contacts', () => {
		...
		expect(render(<ListPeople contacts={contactsList} />)).toBeTruthy();
		expect(render(<ListPeople contacts={contactsList} />).getAllByText('John')).toBeTruthy();
		expect(render(<ListPeople contacts={contactsList} />).getAllByText('Alex')).toBeTruthy();
	})
})


describe('Validation of Inputs', () => {
	it('Check Form for correct Input', () => {
		render(<App />)
